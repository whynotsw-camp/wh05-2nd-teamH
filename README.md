...
- **📌 목표**:  
  사회초년생 구직자들이 **효율적이고 개인화된 정보 제공**을 통해  
  취업 준비를 **체계적으로 수행할 수 있도록 지원하는 AI 기반 서비스 개발**
...
- **📛 프로젝트 이름**: JOB자
- **📅 기간**: 2025-04-05 ~ 2025-08-02
- **👥 팀 구성원**: 서동겸, 김찬호, 이성재, 김민지
...
- 프로젝트에서 효과적으로 수행된 작업 또는 성공 사례
  ...
  - 🤝 팀원 간 원활한 협업과 커뮤니케이션
  - ⏰ 이성재가 어제 지각 안 함  
  - 🍡 찹쌀고로케 맛집 공유 (진심 팀워크 상승)

---

### 2.2 ⚠️ 개선이 필요한 점 (What could be improved)
- 프로젝트 과정에서 비효율적이었거나 개선이 필요한 부분
  - 📄 초기 요구사항 정의가 다소 모호했음
  - 🧹 데이터 전처리에 예상보다 시간이 많이 소요됨
  - 🥲 찹쌀고로케를 너무 늦게 추천해줌 (팀 사기 저하 원인 중 하나)

---

### 2.3 📚 배운 점 (Lessons learned)
- 이번 프로젝트를 통해 새롭게 학습한 내용
  - 🧠 AWS, Docker 등 클라우드 및 컨테이너 기반 기술에 대한 이해 증대
  - 🧪 데이터 파이프라인 구성 및 최적화 전략 습득
  - 🍠 빽다방 고구마빵도 꽤 괜찮음 (단, 일찍 사야 됨)

---

### 2.4 🚀 다음 단계 (Action items)
- 향후 프로젝트에 적용할 개선 방안 또는 실행 계획
  - 📝 초기 설계 및 요구사항 정의에 더 많은 시간 투자
  - 🔁 데이터 전처리 자동화 도구 도입 검토
  - 🌶 월요일 닭발 약속 사수 (사기진작 필수 전략)
...
- **🧑‍💻 팀원 서동겸**  
  - 👍 강점: 주어진 업무를 책임감 있게 수행함  
  - 🔧 개선점: 코드 리뷰 시 세부적인 피드백 추가 필요  

- **🧠 팀원 김찬호**  
  - 👍 강점: 데이터 분석에 창의적인 접근법 적용  
  - 🔧 개선점: 업무 진행 상황을 더 자주 공유하면 좋음  

- **🍡 팀원 이성재**  
  - 👍 강점: 데이터 분석과 메뉴 선정에 탁월한 센스 발휘  
  - 🔧 개선점: 찹쌀고로케 외에도 정기적인 메뉴 브리핑 필요  

- **🎨 팀원 김민지**  
  - 👍 강점: 사용성 중심 UI 기획에 능숙함  
  - 🔧 개선점: 마감 전 중간점검 피드백 공유 주기를 짧게 가져가기
...
- **🏆 성과**
  - 📈 채용 공고 이력 데이터를 활용한 분석 모델 개발 완료
  - 📊 대시보드 및 보고서 시각화 배포 성공
...
- 프로젝트를 진행하며 느낀 점, 제안 사항 등 자유로운 소감 공유

  - 🤝 팀원들 간의 협업이 매우 원활했으며,  
    다음 프로젝트에서도 **이와 같은 커뮤니케이션 방식**을 유지하고 싶음

  - 🕰 일정 관리가 다소 아쉬웠던 부분이 있어,  
    다음 프로젝트에서는 **구체적인 WBS 툴 혹은 간트차트 기반 일정 관리 툴**을 적극 활용하고 싶음

  - 🍽 팀원과의 식사와 고로케 추천, 닭발 약속 등이 프로젝트 집중도를 높여주는 **의외의 시너지**가 됨 😆
